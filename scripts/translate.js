...
const STATIC_PAGES = [
  ...
  { src: 'approach/_Project_list.md',   dest: 'en/approach/_Project_list.md',   permalink: '/en/approach/portfolio/' },
  { src: 'approach/_CRO.md',           dest: 'en/approach/_CRO.md',            permalink: '/en/approach/CRO/' },
